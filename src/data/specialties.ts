...
export const specialties: Specialty[] = [
  ...
  {
    slug: "patologia-oral-y-maxilofacial",
    ...
    heroDescription:
      "La patología oral y maxilofacial se dedica al diagnóstico, tratamiento y seguimiento de enfermedades de la cavidad oral y maxilofacial. Realizamos biopsias y solicitamos exámenes complementarios específicos cuando corresponde.",
